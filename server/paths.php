...
define('ROOT_APLICATION_DB', ROOT_APLICATION . DS . 'Db');
...
define('ROOT_APLICATION_PLUGIN', ROOT_APLICATION . DS . 'Plugin');
...
define('ROOT_APLICATION_TEMP_CACHE', ROOT_APLICATION_TEMP . DS .'cache');
define('ROOT_APLICATION_TEMP_CACHE_DB', ROOT_APLICATION_TEMP_CACHE . DS .'db');
define('ROOT_APLICATION_TEMP_CACHE_SYSTEM', ROOT_APLICATION_TEMP_CACHE . DS .'system');
...
define('ROOT_ASSET_ADMIN_JAVASCRIPT', ROOT_ASSET_ADMIN . DS . 'javascript');
...
set_include_path('.'
  ...
  . PATH_SEPARATOR . ROOT_APLICATION_DB . DS
